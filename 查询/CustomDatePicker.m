...
@property (strong, nonatomic) SelectDateView *pickerView;
...
- (instancetype)init {
    if (self = [super initWithFrame:[[UIScreen mainScreen] bounds]]) {
        ...
        //时间选择View
        _pickerView = [[NSBundle mainBundle] loadNibNamed:NSStringFromClass([SelectDateView class]) owner:self options:nil].lastObject;
        ...
        //DatePicker属性设置
        _selectDate = _pickerView.datePicker.maximumDate;
